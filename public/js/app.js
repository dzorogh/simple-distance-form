...
// require('./bootstrap');
__webpack_require__(/*! ./distance-form */ "./resources/js/distance-form.js");

/***/ }),

/***/ "./resources/js/distance-form.js":
/*!***************************************!*\
  !*** ./resources/js/distance-form.js ***!
  \***************************************/
/***/ (() => {
...
$button.on('click', function (e) {
  ...
  $.post('/api/distance-to-office', {
    ...
    if (result || result === '0') {
      var resultsInKm = Math.round(result / 1000);
      var resultModulusInM = Math.round(result % 1000);
      var resultTest = '';

      if (resultsInKm > 0) {
        resultTest += "".concat(resultsInKm, "\u043A\u043C ");
      }

      resultTest += "".concat(resultModulusInM, "\u043C");
